...
<form action="<c:url value='/cart/completeOrder' />" method="post">
   ...
   <tr> 
      ...
      <td><input type="text" size="20" name="creditCardNumber"  maxlength="25"></td>
      <td align="right">Security Code on the back of card</td>
      <td><input type="text" size="4" name="securityCode"></td>
   </tr>
   <tr> 
