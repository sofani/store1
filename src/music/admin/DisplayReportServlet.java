...
public class DisplayReportServlet extends HttpServlet
{
    ...
    {        
        ...
        {
            reportString = ReportDB.getDownloadDetail(reportTitle, startDate, endDate);
        }
        else if (reportName.equalsIgnoreCase("invoiceSummary"))
        {
            reportString = ReportDB.getOrderSummary(reportTitle, startDate, endDate);
        }
        else if (reportName.equalsIgnoreCase("invoiceDetail"))
        {
            reportString = ReportDB.getOrderDetail(reportTitle, startDate, endDate);
        }
        else
        {
