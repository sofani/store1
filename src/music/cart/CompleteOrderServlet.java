...
public class CompleteOrderServlet extends HttpServlet
{
    ...
    {
    	String username = "sofanib@yahoo.com";
		String password = "s0544596984b";
        ...
        Cookie emailCookie = new Cookie("emailCookie", user.getEmailAddress());
        ...
        String body = "Dear " + user.getFirstName() + ",\n\n" +
            ...
            "Sofani Mesfun\n" +
            "Eritrean Fresh Corn Records";
        boolean isBodyHTML = true;
        try
        {
            MailUtil.sendMail(username, password, to, from, subject, body, isBodyHTML);
        }
